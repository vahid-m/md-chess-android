...
extern int /* boolean */
mythread_create(/*@out@*/ mythread_t *thread, routine_t start_routine, void *arg, /*@out@*/
                          int *ret_error) {
...
/* semaphores */
extern int /* boolean */
mysem_init(mysem_t *sem, unsigned int value) { return -1 !=
                                                      sem_init(sem, 0 /*not shared with processes*/,
                                                               value);
}

extern int /* boolean */
mysem_wait(mysem_t *sem) { return 0 == sem_wait(sem); }

extern int /* boolean */
mysem_post(mysem_t *sem) { return 0 == sem_post(sem); }

extern int /* boolean */
mysem_destroy(mysem_t *sem) { return 0 == sem_destroy(sem); }
