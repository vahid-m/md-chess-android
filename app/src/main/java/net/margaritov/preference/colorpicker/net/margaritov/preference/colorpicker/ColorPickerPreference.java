...
public class ColorPickerPreference
        ...
        net.margaritov.preference.colorpicker.ColorPickerDialog.OnColorChangedListener {
    ...
    private void setPreviewColor() {
        ...
        iView.setBackgroundDrawable(new net.margaritov.preference.colorpicker.AlphaPatternDrawable(
                (int) (5 * mDensity)));
